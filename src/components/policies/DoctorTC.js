...
import { StyleSheet, View, Text, ScrollView, Dimensions, Linking, Alert } from 'react-native';
          ...
          >
            <View style={{ alignSelf: 'center', width: '90%' }}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.parStyles}>
                  5. <Text style={{ fontWeight: 'bold' }}>“Doctor{`'`}s Patients”</Text> shall have
                  the same meaning as defined under the Doctor Agreement
                </Text>
                <Text style={styles.parStyles}>
                ...
                <Text style={styles.parStyles}>
                  ...
                  technology application and platform titled {`'`}TrustHeal{`'`}, owned and operated
                  by the Aggregator.
                </Text>
                <Text style={styles.parStyles}>
                ...
                <Text style={styles.parStyles}>
                  ...
                  TrustHeal Platform as a data maintenance cost for recording and preserving all the
                  data including Doctor-Patients interactions.
                </Text>
                <Text style={styles.parStyles}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.parStyles}>
                    10. Doctor hereby agrees to comply at all times with the Aggregator{`'`}s terms
                    of use, privacy policy, applicable rules and regulations regarding safety,
                  ...
                  <Text style={styles.parStyles}>
                    16. You understand that you will be provided patients{`'`} sensitive information
                    for consultation purposes. You agree not utilize this sensitive patient
                    information for any other purpose except consultation.
                  </Text>
                  <Text style={styles.parStyles}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <View style={{ flex: 1 }}>
                  <Text style={styles.parStyles}>
                    ...
                    Doctor{`'`}s people and property; (ii) prevent nuisance and unnecessary noise
                    and disturbance in Doctor premises; and (iii) act in a safe and lawful manner
                    and comply with the safety standards and policies of Doctor. The employees and
              ...
              <View style={{ flex: 1 }}>
                ...
                <View style={{ flex: 1 }}>
                  <Text style={styles.parStyles}>
                    2. The Agreement is valid for the Term specified in the Doctor{`'`}s Agreement.
                    On the expiry of the Term of this Agreement, the Parties hereto may, by mutual
              ...
              <View style={{ flex: 1 }}>
                ...
                <View style={{ flex: 1 }}>
                  <Text style={styles.parStyles}>
                    ...
                    other organization, or for any purpose other than the Doctor{`'`}s performance
                ...
                <View style={{ flex: 1 }}>
                  <Text style={styles.parStyles}>
                    ...
                    Aggregator shall have no liability to Doctor arising from Aggregator{`'`}s use
                    of any of that Doctorgenerated Material.
                  </Text>
                </View>
              </View>
              {/* QUALITY OF SERVICE */}
              ...
              <View style={{ flex: 1 }}>
                ...
                <View style={{ flex: 1 }}>
                  <Text style={styles.parStyles}>
                    ...
                    which affects the Doctor{`'`}s ability to operate and run Doctor. This Agreement
                    is based on the assumption that the Doctor is in compliance with all such
                ...
                <View style={{ flex: 1 }}>
                  <Text style={styles.parStyles}>
                    ...
                    or other documents of the other Party relating to any of the Party{`'`}s
                    obligations under this Agreement subject to a prior notice in this regard. For
                    the avoidance of doubt, each Party will bear its own costs of conducting or
