          ...
          <View style={{ alignSelf: 'center', width: '90%' }}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={styles.parStyles}>
                ...
                is important to TrustHeal and we (defined below) strive to take care and protect the
                information we (defined below) receive from you (defined below) to the best of Our
                (defined below) ability.
              </Text>
            </View>
            <View style={{ flex: 1 }}>
              <Text style={styles.parStyles}>
                This Privacy Policy (“Privacy Policy”) applies to the collection, receipt, storage,
                usage, processing, disclosure, transfer and protection (“Utilization”) of your
                Personal Information (defined below) when You use the TrustHeal website available at
                URL: www.TrustHeal.in (“Website”) operated by TrustHeal or avail any Services
                offered by TrustHeal through the Website or Application.
              </Text>
            </View>
            <View style={{ flex: 1 }}>
              <Text style={styles.parStyles}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <View style={{ flex: 1 }}>
                <Text style={styles.parStyles}>
                  ...
                  User or by making use of the Services provided by the Website or Application, You
                  unconditionally signify Your (i) assent to the Privacy Policy, and (ii) consent to
                  the Utilisation of your Personal Information in accordance with the provisions of
                  this Privacy Policy.
                </Text>
                <Text style={styles.parStyles}>
                  ...
                  represent that You are authorized by such individual or entity to (i) accept this
                  Privacy Policy on such individual{`'`}s or entity{`'`}s behalf, and (ii) consent
                  on behalf of such individual or entity to Our collection, use and disclosure of
                  such individual{`'`}s or entity{`'`}s Personal Information as described in this
                  Privacy Policy. Further, You hereby acknowledge that the Utilization of Your
                  Personal Information by TRUSTHEAL is necessary for the purposes identified
                  hereunder. You hereby consent that the Utilization of any Personal Information in
                  accordance with the provisions of this Privacy Policy shall not cause any wrongful
                  loss to You.
                </Text>
                <Text style={styles.parStyles}>
                  ...
                  not provide Us Your Personal Information or if You withdraw the consent to provide
                  Us Your Personal Information at any point in time, We shall have the option not to
                  fulfill the purposes for which the said Personal Information was sought and We may
                  restrict You from using the Website, Application or Services.
                </Text>
                <Text style={styles.parStyles}>
                  4. Our Website or Application are not directed at children and We do not knowingly
                  collect any Personal Information from children. Please contact Us at
                  <Text
                    style={{
                      color: 'blue',
            ...
            <View style={{ flex: 1 }}>
              ...
              <View style={{ flex: 1 }}>
                <Text style={styles.parStyles}>
                  1. We reserve the right to update (change, modify, add and/or delete) this Privacy
                  Policy from time to time at our sole discretion. There is a tab at the end of the
                  Privacy Policy which indicates when the Privacy Policy was last updated.
                </Text>
                <Text style={styles.parStyles}>
                  ...
                  TRUSTHEAL may cause Your account to be logged-off and make Your subsequent account
                  log-in conditional on acceptance of the Agreement. If You do not agree to the
                  amendments, please do not use the Website, Application or Services any further.
                </Text>
              </View>
            </View>
            ...
            <View style={{ flex: 1 }}>
              ...
              <View style={{ flex: 1 }}>
                <Text style={styles.parStyles}>
                  In order to provide Services to You we might require You to voluntarily provide Us
                  certain information that personally identifies You or Secondary Users related to
                  You. You hereby consent to the collection of such information by TRUSTHEAL. The
                  information that We may collect from You, about You or Secondary Users related to
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.parStyles}>
                    ...
                    files accessed, errors generated, time zone, operating system and other visitor
                    details collected in Our log files, the pages of our Website or Application that
            ...
            <View style={{ flex: 1 }}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.parStyles}>2. To debug customer support related issues;</Text>
                  <Text style={styles.parStyles}>
                    3. To operate and improve the Website or Application;
                  </Text>
                  <Text style={styles.parStyles}>
                    4. TO PERFORM ACADEMIC/STUDIES, CLINICAL OR OTHER RESEARCH AND ANALYSIS FOR OUR
                    UNDERSTANDING, INFORMATION, ANALYSIS, SERVICES AND TECHNOLOGIES IN ORDER TO
                    PROVIDE ALL USERS IMPROVED QUALITY OF CARE; AND ENSURING THAT THE CONTENT AND
                    ADVERTISING DISPLAYED ARE CUSTOMIZED TO YOUR INTERESTS AND PREFERENCES;
                  </Text>
                  <Text style={styles.parStyles}>
                  ...
                  <Text style={styles.parStyles}>
                    12. To respond to subpoenas, court orders, or legal process, or to establish or
            ...
            <View style={{ flex: 1 }}>
              ...
              <View style={{ flex: 1 }}>
                <Text style={styles.parStyles}>
                  1. You hereby consent and authorize Us to publish feedback obtained by You on Our
                ...
                <Text style={styles.parStyles}>
                  ...
                  Personal Information to third party contractors who work on Our behalf to provide
                  You with Services. These third-party contractors have access to information needed
                  to process Services only and shall not use it for other purposes. Each third-party
                  contractor, the data processor to which We transfer Personal Information shall
                  have to agree to comply with the procedures and policies or put in place adequate
                  measures on their own for maintaining the confidentiality and secure Your Personal
                  Information.
                </Text>
                <Text style={styles.parStyles}>
                  4. You acknowledge that TRUSTHEAL may be obligated to by law to disclose or
                  transfer your Personal Information with Courts and Government agencies in certain
                  instances such as for verification of identity, or for prevention, detection,
                  investigation, prosecution, and punishment for offences, or in compliance with
                  laws such as intimation of diagnosis of an epidemic disease. You hereby consent to
                  disclosure or transfer of Your Personal Information in these instances.
                </Text>
                <Text style={styles.parStyles}>
                  5. Notwithstanding the above, We are not responsible for the confidentiality,
                  security or distribution of Your Personal Information by third-parties outside the
                  scope of Our Agreement. Further, We shall not be responsible for any breach of
                  security or for any actions of any third-parties or events that are beyond the
                  reasonable control of Us including but not limited to, acts of government,
            ...
            <View style={{ flex: 1 }}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <View style={{ flex: 1 }}>
                  <Text style={styles.parStyles}>
                    1. read/write/modify/delete data in relation to the Application on Your device
                    {`'`}s storage;
                  </Text>
                  <Text style={styles.parStyles}>
                  ...
                  <Text style={styles.parStyles}>
                    6. access device information including device identification number required to
            ...
            <View style={{ flex: 1 }}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.parStyles}>
                  ...
                  to store certain data (that is not Sensitive Personal Data or Information). You
                  can erase or choose to block these cookies from Your computer. You can configure
                  Your computer{`'`}s browser to alert You when We attempt to send You a cookie with
                  an option to accept or refuse the cookie. If You have turned cookies off, You may
                  be prevented from using certain features of the Website or Application.
                </Text>
                <Text style={styles.parStyles}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <View style={{ flex: 1 }}>
                <Text style={styles.parStyles}>
                  ...
                  agencies who need to know such Personal Information in relation to the Purposes as
                  specified above in this Policy, provided that such entities agree to abide by this
                  Privacy Policy.
                </Text>
                <Text style={styles.parStyles}>
                  ...
                  You acknowledge that the internet is not 100% secure and that We cannot guarantee
                  absolute security of Your Personal Information. Further, if You are Secondary
                  User, You hereby acknowledge and agree that Your Personal Information may be
                  freely accessible by the Primary User and other Secondary Users and that TRUSTHEAL
                  will not be able to restrict, control or monitor access by Primary User or other
                  Secondary Users to your Personal Information. We will not be liable in any way in
                  relation to any breach of security or unintended loss or disclosure of information
                  caused in relation to Your Personal Information.
                </Text>
              </View>
            </View>
            {/* THIRD PARTY LINKS */}
            <View style={{ flex: 1 }}>
              ...
              <View style={{ flex: 1 }}>
                <Text style={styles.parStyles}>
                  During Your interactions with Us, it may happen that We provide/include links and
                  hyperlinks of third-party websites not owned or managed by Us (“Third-party
                  ...
                  You, other Users or by Us) does not imply endorsement of such Third-party Websites
                  by TRUSTHEAL. Such Third-party Websites are governed by their own terms and
                  conditions and when You access such Third-party Websites, You will be governed by
                  the terms of such Third-party Websites. You must use Your own discretion while
                  accessing or using Third-party Websites. We do not make any representations
                  regarding the availability and performance of any of the Third-party Websites. We
                  are not responsible for the content, terms of use, privacy policies and practices
                  of such Third-party Websites. We do not bear any liability arising out of Your use
            ...
            <View style={{ flex: 1 }}>
              ...
              <View style={{ flex: 1 }}>
                <Text style={styles.parStyles}>
                  ...
                  grievances@trustheal.in and We will take all reasonable efforts to incorporate the
            ...
            <View style={{ flex: 1 }}>
              ...
              <View style={{ flex: 1 }}>
                <Text style={styles.parStyles}>
                  ...
                  the terms of this Privacy Policy are not in accordance with the applicable laws of
                  Your country.
                </Text>
              </View>
            </View>
            ...
            <View style={{ flex: 1 }}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.parStyles}>
                  2. TRUSTHEAL shall store Your Personal Information at least for a period of three
                  years from the last date of use of the Services, Website or Application or for
                  such minimum period as may be required by law.
                </Text>
              </View>
            </View>
            ...
            <View style={{ flex: 1 }}>
              ...
              <View style={{ flex: 1 }}>
                <Text style={styles.parStyles}>
                  We have appointed a grievance officer, whose details are set out below, to address
                  any concerns or grievances that You may have regarding the processing of Your
                  Personal Information. If You have any such grievances, please write to Our
