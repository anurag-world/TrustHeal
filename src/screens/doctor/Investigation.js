        ...
        >
          ...
          <View style={{ flexDirection: 'row' }}>
            ...
            >
              ...
              <TouchableOpacity onPress={() => {}}>
                <Image source={investigation} style={[{ tintColor: '#2B8ADA' }]} />
              </TouchableOpacity>
              <TouchableOpacity onPress={() => {}}>
                    ...
                    >
                      ...
                      >
                        ...
                        <View style={styles.cellHeading}>
                          <Text style={styles.cellHeadingText}>Investigation</Text>
                        </View>
