...
export default function PatientAllAppointments() {
  ...
  useEffect(() => {
    const LoadData = async () => {
      ...
      setisLoading(true);
      await axios
        .get(`${apiConfig.baseUrl}/patient/consultations?max=100&min=0&patientId=${x.patientId}`)
        .then((response) => {
          console.log(
    ...
    >
      ...
      >
        ...
        {!isEmpty(item.familyMemberName) && (
          ...
          >
            ...
            />
            <Text style={{ color: '#17CC9C', alignSelf: 'center', fontSize: 13 }}>
      ...
      <View style={{ flexDirection: 'column' }}>
        ...
        >
          ...
          >
            <FAIcons name="file-pdf" color="white" size={15} style={{ marginRight: 5 }} />
