...
export default function SupportPatient() {
  ...
  const getQuery = async () => {
    setisLoading(true);
    await axios
      .get(`${apiConfig.baseUrl}/patient/help?patientId=${patientId}`)
      .then((response) => {
  ...
  const dropdownData = [
    ...
    { key: 'Scheduling Consultation', value: 'Scheduling Consultation' },
    { key: 'Doctor Related', value: 'Doctor Related' },
  ...
  const renderDocs = ({ item }) => (
    <View
      style={[
        ...
        !DocsUploaded && { borderColor: '#2b8ada', borderWidth: 1 },
      ]}
  ...
  const submitQuery = async () => {
    ...
    for (let i = 0; i < docList.length; i += 1) {
      try {
        ...
        if (error != null) {
          ...
          if (!isEmpty(response.fileToken)) files.push(response.fileToken);
        }
      } catch (e) {
        console.log(e);
      }
    ...
    await axios
      .post(`${apiConfig.baseUrl}/patient/help`, queryJson)
      .then((response) => {
        if (response.status === 200) {
          Alert.alert(
            'Success',
              ...
              >
                ...
                <View style={{ flex: 1, padding: 10 }}>
                  ...
                  <TextInput
                    ...
                    maxLength={300}
                  />
                  <Text style={{ fontSize: 12, color: 'black' }}>{message.length}/300</Text>
                </View>
                {/* Attatchments */}
                <View style={{ flex: 1, padding: 10 }}>
              ...
              <View style={{ minHeight: 150, width: '100%' }}>
                ...
                >
                  {DisplayPhotoToken === 0 ? (
                    ...
                    <Image
                      source={{
                        uri: `${apiConfig.baseUrl}/file/download?fileToken=${DisplayPhotoToken}&userId=${patientId}`,
                      }}
                      style={{
                        resizeMode: 'cover',
                        width: '100%',
          ...
          >
            ...
            >
                ...
                >
                  <CustomButton
                    ...
                    style={[
                      ...
                      Rating && { backgroundColor: '#2b8ada' },
                    ]}
                    textstyle={[{ color: '#2b8ada', fontSize: 12 }, Rating && { color: 'white' }]}
                    onPress={() => {
                      setRating(true);
                    }}
                  />
                  <CustomButton
                    ...
                    style={[
                      ...
                      Rating === false && { backgroundColor: '#2b8ada' },
                    ]}
                    textstyle={[
                      { color: '#2b8ada', fontSize: 12 },
                      Rating === false && { color: 'white' },
                    ]}
                    onPress={() => {
                      setRating(false);
                    }}
              ...
              <CustomButton
                ...
                onPress={async () => {
                  console.log(`${apiConfig.baseUrl}/patient/query/feedback`, {
                  ...
                  await axios
                    .post(`${apiConfig.baseUrl}/patient/query/feedback`, {
                      feedback: feedbackMsg,
                      helpId,
                      isSatisfied: Rating,
                    })
